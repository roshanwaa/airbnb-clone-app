...
export const AccountNavigation = () => {
  ...
  function linkToClass(type = null) {
    let classes = 'inline-flex gap-2 py-2 px-4 items-center';
    if (type === subpage) {
      classes +=
  ...
  return (
    <>
      <nav className="w-full flex justify-center mt-6 mb-8 gap-4">
        <Link to={'/account/profile'} className={linkToClass('profile')}>
          <svg
        ...
        <Link to={'/account/bookings'} className={linkToClass('bookings')}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
        ...
        <Link to={'/account/places'} className={linkToClass('places')}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
